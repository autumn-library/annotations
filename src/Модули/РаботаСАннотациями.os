...
//   ЗначениеПараметра - Произвольный - Значение параметра.
//
Процедура ДобавитьЗначениеПараметраАннотации(Аннотация, ИмяПараметра, ЗначениеПараметра) Экспорт
	Параметр = Аннотация.Параметры.Добавить();
	Параметр.Имя = ИмяПараметра;
	Параметр.Значение = ЗначениеПараметра;
КонецПроцедуры

// Проверить, является ли значение вложенной аннотацией.
//
// Начиная с OneScript 2.0.0 значением параметра аннотации может быть другая
// аннотация. Рефлектор представляет её строкой таблицы значений с колонками
// "Имя" и "Параметры", как и строку таблицы аннотаций.
//
// Параметры:
//   Значение - Произвольный - Проверяемое значение параметра аннотации.
//
//  Возвращаемое значение:
//   Булево - Истина, если значение является вложенной аннотацией.
//
Функция ЭтоОписаниеАннотации(Значение) Экспорт
	...
	Возврат Колонки.Найти("Имя") <> Неопределено И Колонки.Найти("Параметры") <> Неопределено;
