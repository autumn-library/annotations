...
//                                             см. РаботаСАннотациями.ЭтоАннотация).
//   КонтейнерАннотаций - КонтейнерАннотаций - Контейнер определений аннотаций. Если задан, значения-параметры,
//                                             являющиеся вложенными аннотациями, рекурсивно превращаются
//                                             в объекты соответствующих аннотаций. По умолчанию Неопределено:
//                                             вложенные аннотации остаются строками таблицы значений.
//
// Возвращаемое значение:
//   Произвольный - Объект аннотации с заданными параметрами.
//
Функция СоздатьОбъектАннотации(Аннотация, Знач КонтейнерАннотаций = Неопределено) Экспорт
	...
	Для Каждого Параметр Из Параметры() Цикл
		...
		Если Параметр.Повторяемый Тогда
			...
			Для Каждого Значение Из ЗначенияПараметра Цикл
				ЗначениеПараметра.Добавить(МатериализоватьЗначение(Значение, КонтейнерАннотаций));
			КонецЦикла;
		Иначе
			...
			ЗначениеПараметра = МатериализоватьЗначение(Значение, КонтейнерАннотаций);
		КонецЕсли;
...
// а её определение зарегистрировано в контейнере, вложенная аннотация рекурсивно
// превращается в объект своей аннотации. В остальных случаях значение возвращается как есть.
//
// Параметры:
//   Значение             - Произвольный         - Значение параметра (литерал или вложенная аннотация).
//   КонтейнерАннотаций   - КонтейнерАннотаций    - Контейнер определений аннотаций для рекурсивной
//                                                  материализации. Если Неопределено, материализация не выполняется.
//
//  Возвращаемое значение:
//   Произвольный - Материализованное значение (объект вложенной аннотации либо исходное значение).
//
Функция МатериализоватьЗначение(Значение, КонтейнерАннотаций)
	...
	Возврат ОпределениеВложеннойАннотации.СоздатьОбъектАннотации(Значение, КонтейнерАннотаций);
