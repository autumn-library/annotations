...
// Состояние приложения в котором необходимо обработать Аннотацию
Перем МоментВыполнения;
...
// Момент обработки аннотации.
//
//  Возвращаемое значение:
//   Строка
//
Функция МоментВыполнения() Экспорт
	Возврат МоментВыполнения;
КонецФункции
...
Процедура ПриСозданииОбъекта(Знач _Имя, Знач _ИмяТипаАннотации, Знач _Параметры, Знач _Аннотации, Знач _МоментВыполнения)
	
	Имя = _Имя;
	МоментВыполнения = _МоментВыполнения;
