...
// Контейнер определений аннотаций, которому принадлежит данное определение.
...
Процедура ПриСозданииОбъекта(Знач _Имя, Знач _ИмяТипаАннотации, Знач _Параметры, Знач _Аннотации, Знач _КонтейнерАннотаций = Неопределено)
