...
Процедура ПроверитьРазвернутьАннотацииСвойств(ВладелецОбъект)
...
&Тест
Процедура РазвернутьАннотацииСвойствДляТипа() Экспорт
	ПроверитьРазвернутьАннотацииСвойств(Ложь);
КонецПроцедуры

&Тест
Процедура РазвернутьАннотацииСвойствДляОбъекта() Экспорт
	ПроверитьРазвернутьАннотацииСвойств(Истина);
КонецПроцедуры
